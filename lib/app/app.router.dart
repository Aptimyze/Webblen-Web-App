...
class Routes {
  ...
  static String TicketSelectionViewRoute({@required dynamic id}) => '/tickets/select/$id';
  static const String _TicketPurchaseViewRoute = '/tickets/purchase/:id/:ticketsToPurchase';
  static String TicketPurchaseViewRoute({@required dynamic id, @required dynamic ticketsToPurchase}) => '/tickets/purchase/$id/$ticketsToPurchase';
  ...
  static String EventTicketsViewRoute({@required dynamic id}) => '/wallet/my_tickets/event/$id';
  static const String _TicketDetailsViewRoute = '/tickets/view/:id';
  static String TicketDetailsViewRoute({@required dynamic id}) => '/tickets/view/$id';
...
class StackedRouter extends RouterBase {
  ...
  final _routes = <RouteDef>[
    ...
    RouteDef(Routes.SetUpInstantDepositViewRoute, page: SetupInstantDepositView),
  ];
  @override
  ...
  final _pagesMap = <Type, StackedRouteFactory>{
    AuthView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => const AuthView(),
        settings: data,
    ...
    WebblenBaseView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => WebblenBaseView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    PostView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => PostView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    CreatePostView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => CreatePostView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    EventDetailsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => EventDetailsView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    CreateEventView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => CreateEventView(
    ...
    LiveStreamDetailsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => LiveStreamDetailsView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    CreateLiveStreamView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => CreateLiveStreamView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    TicketSelectionView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => TicketSelectionView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    TicketPurchaseView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => TicketPurchaseView(
          data.pathParams['id'].value,
    ...
    AllSearchResultsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => AllSearchResultsView(data.pathParams['term'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    UserProfileView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => UserProfileView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    EditProfileView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => EditProfileView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    UserFollowersView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => UserFollowersView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    UserFollowingView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => UserFollowingView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    MyTicketsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => MyTicketsView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    EventTicketsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => EventTicketsView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    TicketDetailsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => TicketDetailsView(data.pathParams['id'].value),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    PayoutMethodsView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => PayoutMethodsView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    HowEarningsWorkView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => HowEarningsWorkView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    SetupDirectDepositView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => SetupDirectDepositView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
    SetupInstantDepositView: (data) {
      return PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) => SetupInstantDepositView(),
        settings: data,
        transitionDuration: const Duration(milliseconds: 0),
      );
    },
